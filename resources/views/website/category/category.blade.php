                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div class="card">
                        <div class="card-img-wrapper overlay-rounded-top">
                            <img class="card-img-top" src="{{asset('/')}}website/images/background/page-title.jpg" alt="blog-thumbnail">
                        </div>
                        <div class="card-body p-0">
                            <div class="d-flex">
                                ...
                                <div class="p-3">
                                    <a href="{{route('blog-detail')}}" class="h4 font-primary text-dark">jdjr</a>
                                    <p>by -faria</p>
                                </div>
                            </div>
                        </div>
